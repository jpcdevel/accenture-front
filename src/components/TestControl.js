...
import ReportItem from "../controls/ReportItem";
            ...
            <>
                <div class={"portfolioOverview d-block mt-2"}>
                    ...
                    <Row>
                        <Col span={6}>
                            <Card bordered={false}>
                                <ReportItem value={"110$"} description={"Обьем счета"} font_size={25}/>
                                <ReportItem value={"+80%"} description={"Средняя доходность(CAGR)"} font_size={25}/>
                                <ReportItem value={"11"} description={"Коэффициент Шарпа(SR)"} font_size={25}/>
